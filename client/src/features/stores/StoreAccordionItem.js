        ...
        <Accordion.Item key={displayedStore.id} eventKey={displayedStore.id}>
            ...
            <Accordion.Body>
                ...
                <ButtonGroup className="mb-3">
                    ...
                    <Link className="btn btn-outline-dark" to="/sale" state={{store: store}}>Sale</Link>
                    <Link className="btn btn-outline-dark" to="/customer" state={{store: store}}>Customer</Link>
                </ButtonGroup>
